...
module.exports={
	create:function(options, callback){
		...
		function spawnPhantom(port){
			var args = [];
			for (var option in options.phantomjs) {
				args.push('--' + option + '=' + options.phantomjs[option]);
			}
			args = args.concat([__dirname + '/bridge.js', port]);

			var phantom=child.spawn(require('phantomjs').path,args);
